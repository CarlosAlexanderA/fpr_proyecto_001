	...
	<div class="caption">
		...
		<div>
			<div>
				...
				$sql1 = "SELECT planes.id,proveedor.nombre,planes.nombre,planes.precio,planes.estado FROM planes INNER JOIN proveedor on planes.id_proveedor=proveedor.id WHERE planes.id=$id_get;";
		...
		<form action="ejecutaactualizar3.php" method="post">
			...
			<div>
				<label for="email">
					...
					<input type="text" name="precio" value="<?php echo $precio ?>"> </label>
			</div>
			<div>
				<label for="subject">
					<span>Estado: </span>
