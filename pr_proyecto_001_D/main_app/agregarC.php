...
<head>
	<meta charset="utf-8">
	<title>Pagina de Agregacion</title>
	...
	<div class="caption">
		...
		<div>
			<div>
				...
				$sql1 = "insert into lg.id, lg.nombre, lg.apellido, lg.telefono, cli.estado FROM login as lg INNER JOIN cliente as cli on lg.id=cli.id_login WHERE lg.id=$id_get;";
